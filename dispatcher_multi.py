...
"""Claude Code PreToolUse permission hook — auto-generated by dispatcher_multi.py"""
...
async def main():
    ...
    async def handle_media(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        ack = await msg.reply_text(
            f"⏳ *{MACHINE_NAME}* — downloading {media_type}…", parse_mode="Markdown")
        ...
        await ack.edit_text(
            f"⏳ *{MACHINE_NAME}* — Claude analyzing {media_type} in `{Path(wd).name}`…",
            parse_mode="Markdown")
